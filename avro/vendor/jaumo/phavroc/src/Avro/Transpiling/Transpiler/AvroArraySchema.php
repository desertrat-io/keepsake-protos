...
use Avro\Model\Schema\Array_ as ArraySchema;
...
final class AvroArraySchema implements Transpiler, TranspilerAware
{
    use HasTranspiler;
    ...
    public function transpile(Schema $schema, Package $package): Package
    {
        ...
        return $this->transpiler->transpile($items, $package);
    }
}
